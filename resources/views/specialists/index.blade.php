    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manajemen Keahlian</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        @card
                            ...
                            @endif
​
                            <form role="form" action="{{ route('keahlian.store') }}" method="POST">
                                @csrf
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('keahlian.destroy', $row->id) }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <div class="btn-group" role="group" aria-label="Basic example">

                                                    <a href="{{ route('keahlian.edit', $row->id) }}" class="btn btn-warning "><i class="fa fa-edit"></i></a>
